  ...
  if (navigator.geolocation)
	...
	var getTodaysEvents = function(currentDate,currentDate){
					var sfartsProxy = new sfarts();
						...
						sfartsProxy.getMasterEventsByDateByLocation(currentDate,currentDate);
	...
	<div data-role="header">
		<h1>Closest Events <br />in All Disciplines<br />  <cfoutput>for #dateformat(currentDate,"mm/dd/yy")# </cfoutput></h1>
	</div>
