  ...
  if (navigator.geolocation)
	...
	var getTodaysEvents = function(currentDate,currentDate){
					var sfartsProxy = new sfarts();
						...
						sfartsProxy.getVisualEventsByDateByLocation(currentDate,currentDate);
	...
	<div data-role="header">
		<h1>Closest Events in <br />Galleries <br />and Museums<br />  <cfoutput>for #dateformat(currentDate,"mm/dd/yy")# </cfoutput></h1>
	</div>
