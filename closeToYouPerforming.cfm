  ...
  if (navigator.geolocation)
	...
	var getTodaysEvents = function(currentDate,currentDate){
					var sfartsProxy = new sfarts();
						...
						sfartsProxy.getPerformingEventsByDateByLocation(currentDate,currentDate);
	...
	<div data-role="header">
		<h1>Closest Events in <br />Music, <br /> Theater and Dance<br />  <cfoutput>for #dateformat(currentDate,"mm/dd/yy")# </cfoutput></h1>
	</div>
